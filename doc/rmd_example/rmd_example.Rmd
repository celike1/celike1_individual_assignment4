...
```{r sd-table, echo =FALSE, message=FALSE, warning=FALSE}
horses_sd_table <- read_csv("../../results/horses_sd.csv")
largest_sd <- horses_sd_table$Province[1]
knitr::kable(horses_sd_table, caption = "Standard deviation of the number of horses in Canadian provinces")
```
...
```{r horse-pop-plot-largest-sd, echo=FALSE, out.width="65%", fig.cap = "Horse populations for the province with the largest standard deviation"}
